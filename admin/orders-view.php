                ...
                if($orders){
                    if(mysqli_num_rows($orders)){
                        ...
                        <?php 
                            ...
                            $orderItemsResult = mysqli_query($con, $orderItemQuery);
                            if($orderItemsResult){
                                ...
                                ?>
                                    ...
                                    <table class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php foreach($orderItemsResult as $orderItemRow) : ?>
                                                <tr>
                                                    <td>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="3" class="text-end fw-bold">MMK: <?= number_format($orderItemRow['total_amount'],0); ?></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                <?php
