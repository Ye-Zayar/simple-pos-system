            ...
            <input type="hidden" name="categoryId" value="<?= $category['data']['id']; ?>">
                <div class="row">
                    <div class="col-md-12 mb-3">
                        ...
                        <input value="<?= $category['data']['name'] ?>" type="text" name="name" required class="form-control">
                    </div>
                    <div class="col-md-12 mb-3">
                    ...
                    <div class="col-md-12">
                        ...
                        <br>
                        <input <?= $category['data']['status'] == true ? 'checked':''; ?> type="checkbox" name="status" style="width: 30px;height:30px">
                    </div>
