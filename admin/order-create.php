    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="bm-3">
            ...
            <input type="text" name="name" class="form-control" id="c_name">
        </div>
        <div class="bm-3">
            <label for="phone">Enter Customer Phone Number <span class="text-danger">*</span></label>
            <input type="text" name="phone" class="form-control" id="c_phone">
        </div>
        <div class="bm-3">
            <label for="email">Enter Customer Email (optional)</label>
            <input type="text" name="email" class="form-control" id="c_email">
        </div>
      </div>
